...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var calculator_bmi:Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)
        display_bmi = findViewById(R.id.bmidisp)
        weight_text = findViewById(R.id.weightedt)
        height_text = findViewById(R.id.heightedt)
        calculator_bmi = findViewById(R.id.calcbtn)

        calculator_bmi.setOnClickListener {
